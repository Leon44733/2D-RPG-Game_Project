 ...
 *  Author: lbarwe
 *  -----
 *  Last Modified: Sa 08.March 2025, 7:06:36 pm
 *  Modified By: lbarwe
 *  -----
...
namespace gfx
{
    namespace render
    {
        ...
        void RendererManager::renderCharElement(std::string aName, std::shared_ptr<ICamera> aCamera)
        {
            ...
            {
                mCharElements[aName]->render(*this, aCamera);
            }
        }
