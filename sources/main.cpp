 ...
 *  Author: lbarwe
 *  -----
 *  Last Modified: Sa 08.March 2025, 8:10:57 pm
 *  Modified By: lbarwe
 *  -----
...
int main() 
{
    ...
    tManager->load("assets/images/heli2.png", "Player", rManager->getRenderer());
    ...
    std::shared_ptr<entities::characters::PlayerCharacter> playerElem = std::make_shared<entities::characters::PlayerCharacter>(288, 148, 1, playerTexture);
