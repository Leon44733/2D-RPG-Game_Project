 ...
 *  Author: lbarwe
 *  -----
 *  Last Modified: Sa 08.March 2025, 6:32:01 pm
 *  Modified By: lbarwe
 *  -----
  ...
  namespace elem
  {
    ...
    class TextureElement : public gfx::render::Renderable
    {
      public:
        ...
        void render(gfx::render::RendererManager& aRenderer, std::shared_ptr<gfx::render::ICamera> aCamera) override {}; // not needed for TextureElement
    };
  }
}
